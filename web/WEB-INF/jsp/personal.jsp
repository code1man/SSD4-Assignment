...
<div class ="main-content">
    ...
    <div class="user-profile">
        <div class="avatar" >
            <img id="show-avatar" src="/static/image/nailong.gif" alt="用户头像" style ="z-index:1">
        </div>
        <div class="user-info">
            ...
            <span class="gender" id="show-gender">
                <img src="/static/image/gender1.png" alt="性别" style="z-index:1"/>
        </span>
            <br/>
    ...
    <div class="tab-container">
        ...
        <div class="tab-content">
            <div class="tab-panel active" id="notes">
                <div class="temp-note">
                    <span style="margin-top: 50px;"><img style="width: 180px; height: auto;z-index:1" src="/static/image/bg1.png" alt="笔记"></span><br/>
            ...
            <div class="tab-panel" id="collections">
                ...
                <span style="margin-top: 50px;">
                    <img style="width: 180px; height: auto; z-index:1" src="/static/image/bg1.png" alt="笔记">
                </span>
                            <br/>
                    ...
                    <div class="inner-tab-panel" id="albums">
                        <div class="temp-collection">
                <span style="margin-top: 50px;">
                    <img style="width: 180px; height: auto; z-index:1" src="/static/image/bg1.png" alt="专辑">
                </span><br/>
                            <span class="smaller">你还没有创建过任何专辑哦</span>
                        </div>

                        <button class="create-album-btn" style="z-index:998">+ 创建专辑</button>
                    </div>
                </div>
            </div>
            ...
            <div class="tab-panel" id="likes">
                <div class="temp-like">
                    <span style="margin-top: 50px; z-index:1"><img style="width: 180px; height: auto;" src="/static/image/bg1.png" alt="点赞"></span><br/>
